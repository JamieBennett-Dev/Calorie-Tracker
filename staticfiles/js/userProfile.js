    ...
    datasets: [
      {
        ...
        data: values,
        lineTension: 0.3,
        backgroundColor: 'rgba(0,204,78 ,0.2)',
        borderColor: 'rgba(0,204,78 ,1)',
        pointRadius: 5,
        pointBackgroundColor: 'rgba(0,204,78 ,1)',
        pointBorderColor: 'rgba(0,204,78, 0.8)',
        pointHoverRadius: 5,
        pointHoverBackgroundColor: 'rgba(0,204,78 ,1)',
        pointHitRadius: 50,
        pointBorderWidth: 2,
      },
    ],
